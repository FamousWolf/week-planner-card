                            ...
                            ${day.events.length === 0 ?
                                ...
                                html`
                                    ${day.events.map((event) => {
                                        return html`
                                            <div class="event ${event.class}" data-entity="${event.calendar}" style="--border-color: ${event.color}; --event-background-color: ${event.background}" @click="${() => { this._handleEventClick(event) }}">
                                                <div class="time">
                                                    ${event.fullDay ?
