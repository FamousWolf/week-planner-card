...
| `compact`                | boolean          | false                                              | `false` \| `true`                                                                                                                           | Deprecated: use `displayMode: compact` instead. Kept for backwards compatibility.      | 1.2.0   |
| `displayMode`            | string           | `default`                                          | `default` \| `compact` \| `compactAllDay`                                                                                                   | Card display mode. `compact` decreases spacings and font sizes for all events; `compactAllDay` only reduces the size of all day events. | 1.16.0  |
| `hideEntireDayLabel`     | boolean          | false                                              | `false` \| `true`                                                                                                                           | Hide the "Entire day" label on all day events                                          | 1.16.0  |
